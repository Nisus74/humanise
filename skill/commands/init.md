...
5. Ask for 5 to 10 writing samples; save them to `profile/voice-corpus/` per channel. Then run `scripts/generate-fingerprint.md` to write `profile/voice-fingerprint.md`.
