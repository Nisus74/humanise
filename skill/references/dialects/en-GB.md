...
**Idiom:** at university (not in college), lift (not elevator), flat (not apartment), CV (not resume), holiday (not vacation).

**Register:** closer to AU than US; moderate formality.
